...
<header>
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="viewdancers.php">View Dancers</a></li>
            </ul>
        </nav>
...
<section style="align-items: center;width: 100%;background-color: grey;">
<H1 style="text-align: center;font-size:3em;">puea dancers</H1>



    <table id="viewdancers
    " style="margin-top:20px; font-size:3em;border: 1px solid;width: 100%;">
        <thead>
        <tr  style="text-align: center;color:aqua;">
            <td>username</td>
            <td>email</td>
            <td>phone</td>
...
<?php
        require 'db.php';
        $sql = "SELECT `username`,`email`,`phone` FROM dancers";
    ...
    <section class="contacts" id="contacts">
        ...
        <div class="row">
        <form action="viewdancers.php" method="post">
...
if (isset($_POST['submit']))
{
    ...
    $sql ="INSERT INTO `getus`(`Names`, `email`, `number`, `message`) VALUES
     ...
     header("Location:viewdancers.php");
